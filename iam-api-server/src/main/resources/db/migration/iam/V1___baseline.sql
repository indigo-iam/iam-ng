...
create table REALMS (ID bigint not null auto_increment, AUP_URL varchar(128), CONFIG longtext not null, DESCRIPTION varchar(512), LOGO_URL varchar(128), CREATION_TIME datetime(6) not null, LAST_UPDATE_TIME datetime(6) not null, NAME varchar(255), PRIVACY_POLICY_URL varchar(128), REGISTRATION_ENABLED bit not null, primary key (ID)) ;
