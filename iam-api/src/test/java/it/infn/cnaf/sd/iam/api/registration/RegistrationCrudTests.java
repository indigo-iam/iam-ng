...
import it.infn.cnaf.sd.iam.api.apis.registration.RegistrationRequestMapper;
import it.infn.cnaf.sd.iam.api.apis.registration.dto.RegistrationRequestCreationResultDTO;
import it.infn.cnaf.sd.iam.api.apis.registration.dto.RegistrationRequestDTO;
...
public class RegistrationCrudTests extends IntegrationTestSupport
  ...
  public void testInvalidRequestAccess() throws Exception {
    mvc.perform(post("/api/alice/Registrations"))
  ...
  public void testSimpleRequestCreationSuccess() throws Exception {
    ...
    mvc
      .perform(post("/api/alice/Registrations").content(mapper.writeValueAsString(dto))
  ...
  public void testSimpleRequestCreationSuccessAuthenticated() throws Exception {
    ...
    String response = mvc
      .perform(post("/api/alice/Registrations").with(jwt())
