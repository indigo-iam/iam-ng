...
public class GroupsCrudTests extends IntegrationTestSupport {
  ...
  public void testUnauthenticatedAccess() throws Exception {
    mvc.perform(get("/Realms/alice/Groups")).andExpect(status().isUnauthorized());
  }

  @WithMockUser
  @Test
  public void testUnauthorizedAccess() throws Exception {
    mvc.perform(get("/Realms/alice/Groups")).andExpect(status().isForbidden());
  }

  @WithMockAdminUser
  @Test
  public void testAuthorizedAccess() throws Exception {
    mvc.perform(get("/Realms/alice/Groups")).andExpect(status().isOk());
  }

  @WithMockAdminUser
  @Test
  public void testUnknownRealmAccess() throws Exception {
    mvc.perform(get("/Realms/unknown/Groups"))
  ...
  public void testGetGroupSuccess() throws Exception {
    mvc.perform(get("/Realms/alice/Groups/{id}", ALICE_PRODUCTION_GROUP_UUID))
  ...
  public void testGroupDeletion() throws Exception {
    ...
    mvc.perform(get("/Realms/alice/Groups/{id}", createdGroup.getUuid()))
      .andExpect(status().isOk())
      .andExpect(jsonPath("$.name").value("test"));

    mvc.perform(delete("/Realms/alice/Groups/{id}", createdGroup.getUuid()))
  ...
  public void testGroupDeletionFailsForGroupWithChildren() throws Exception {
    mvc.perform(delete("/Realms/alice/Groups/{id}", ALICE_GROUP_UUID))
      .andExpect(status().isBadRequest())
