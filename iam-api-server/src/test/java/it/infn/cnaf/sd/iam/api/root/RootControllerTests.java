 ...
 */
package it.infn.cnaf.sd.iam.api.root;
...
@IamTest
public class RootControllerTests extends IntegrationTestSupport{
  ...
  public void testInvalidRequestAccess() throws Exception {
    mvc.perform(get("/"))
      ...
      .andExpect(jsonPath("$.apiDocumentationPath", is(apiDocsPath)));
  }
